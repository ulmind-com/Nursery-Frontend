      ...
      {whatsapp && (
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 175.216 175.552" className="size-8">
            ...
            <path fill="#fff" d="M87.184 25.227c-33.733 0-61.166 27.423-61.178 61.13a60.98 60.98 0 0 0 9.349 32.535l1.455 2.313-6.179 22.558 23.146-6.069 2.235 1.324a61.22 61.22 0 0 0 31.129 8.481h.032c33.707 0 61.14-27.426 61.153-61.135a60.75 60.75 0 0 0-17.895-43.251 60.75 60.75 0 0 0-43.247-17.886z"/>
            <path fill="url(#wa-b)" d="M87.184 25.227c-33.733 0-61.166 27.423-61.178 61.13a60.98 60.98 0 0 0 9.349 32.535l1.455 2.313-6.179 22.558 23.146-6.069 2.235 1.324a61.22 61.22 0 0 0 31.129 8.481h.032c33.707 0 61.14-27.426 61.153-61.135a60.75 60.75 0 0 0-17.895-43.251 60.75 60.75 0 0 0-43.247-17.886z"/>
