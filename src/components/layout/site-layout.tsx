    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      {whatsapp && (
        <a
          ...
          className="fixed bottom-24 right-4 z-40 transition-transform duration-200 hover:scale-110 lg:bottom-8 animate-[wa-bounce_2s_ease-in-out_infinite]"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 175.216 175.552" className="size-16 drop-shadow-xl lg:size-[4.5rem]">
            ...
            <circle cx="87.608" cy="87.776" r="87.776" fill="#25d366"/>
            <path fill="#fff" d="M87.503 30.878c-31.458 0-57.062 25.596-57.073 57.028a56.89 56.89 0 0 0 8.72 30.342l1.357 2.157-5.762 21.034 21.579-5.66 2.085 1.235a57.1 57.1 0 0 0 29.054 7.91h.03c31.432 0 57.037-25.6 57.048-57.033a56.66 56.66 0 0 0-16.69-40.34 56.66 56.66 0 0 0-40.348-16.673z"/>
            <path fill="#25d366" d="M87.503 35.184c-29.124 0-52.824 23.694-52.834 52.797a52.72 52.72 0 0 0 8.079 28.106l1.258 1.998-5.34 19.488 19.99-5.242 1.93 1.144a52.86 52.86 0 0 0 26.882 7.326h.028c29.098 0 52.8-23.698 52.81-52.8a52.47 52.47 0 0 0-15.45-37.34 52.47 52.47 0 0 0-37.353-15.477z"/>
