...
export function SpotlightSection({ promos }: { promos: SpotlightPromo[] }) {
  ...
  return (
    <section className="bg-storefront-wash py-12 lg:py-16">
      ...
      <div className="grid w-full grid-cols-1 overflow-hidden shadow-md md:grid-cols-2">
        {promos.map((promo, index) => {
          const isLeft = index === 0;
          return (
            <div key={promo.id} className="group relative flex aspect-[4/5] md:aspect-[4/3] lg:aspect-auto lg:h-[600px] w-full flex-col overflow-hidden bg-background">
